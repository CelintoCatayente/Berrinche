...
(function() {
  ...
  $(document).on("page:change", function() {
    $("#link-documentales").click(function() {
      ...
      return $("#video-mosaic .documentales img").addClass("active");
    });
    $("#link-publicidad").click(function() {
      $("#link-documentales, #link-publicidad, #link-self-production, #link-corporativos, #link-television").removeClass("active");
      $("#link-publicidad").addClass("active");
      $("#video-mosaic img").removeClass("active");
      return $("#video-mosaic .publicidad img").addClass("active");
    });
    ...
    $("#link-corporativos").click(function() {
      $("#link-documentales, #link-publicidad, #link-self-production, #link-corporativos, #link-television").removeClass("active");
      $("#link-corporativos").addClass("active");
      $("#video-mosaic img").removeClass("active");
      return $("#video-mosaic .corporativos img").addClass("active");
    });
    return $("#link-television").click(function() {
      $("#link-documentales, #link-publicidad, #link-self-production, #link-corporativos, #link-television").removeClass("active");
      $("#link-television").addClass("active");
      $("#video-mosaic img").removeClass("active");
      return $("#video-mosaic .television img").addClass("active");
    });
  });
